...
`./bin/opensearch-plugin install https://github.com/aiven/prometheus-exporter-plugin-for-opensearch/releases/download/2.0.0.0-rc1/prometheus-exporter-2.0.0.0-rc1.zip`
