...
`./bin/opensearch-plugin install https://github.com/aiven/prometheus-exporter-plugin-for-opensearch/releases/download/2.19.0.0/prometheus-exporter-2.19.0.0.zip`
